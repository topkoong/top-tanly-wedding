...
export const venueContentEn: VenueContent = {
  ...
  eventSpaces: [
    { room: "Beverly Hills", floor: "Floor 2 · Annex Building", eventName: "Engagement & Rubwai Ceremony" },
    { room: "Conrad Ballroom", floor: "Floor 4 · Main Building", eventName: "Wedding Reception" },
  ],
  transport: [
    {
      icon: "car",
      label: "Grab / Taxi",
      detail: "Search \"Conrad Bangkok\" on Wireless Road — drop-off at the main hotel entrance.",
    },
    {
      icon: "train",
      label: "BTS Skytrain",
