...
export const venueContentTh: VenueContent = {
  ...
  eventSpaces: [
    { room: "Beverly Hills", floor: "ชั้น 2 · อาคาร Annex", eventName: "พิธีหมั้นและพิธีรับไหว้" },
    { room: "Conrad Ballroom", floor: "ชั้น 4 · อาคารหลัก", eventName: "งานเลี้ยงฉลองมงคลสมรส" },
  ],
  transport: [
    {
      icon: "car",
      label: "Grab / แท็กซี่",
      detail: "ค้นหา \"Conrad Bangkok\" ถนนวิทยุ — รับส่งที่ทางเข้าหลักของโรงแรม",
    },
    {
      icon: "train",
      label: "รถไฟฟ้า BTS",
